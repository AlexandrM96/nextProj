...
export const HHData = ({count, juniorSalary, middleSalary, seniorSalary}: HHDataProps): JSX.Element => {
    ...
    return (
        <div className={styles.hhData}>
            <Card className={styles.hhDataCountContent}>
                <div className={styles.hhDataCountContentTitle}>
                    Всего вакансий
                </div>
                <div className={styles.hhDataCountContentCount}>
                    {count}
                </div>
            </Card>
            <Card className={styles.hhDataSalary}>

                <div>
                    <div className={styles.hhDataSalaryTitle}>
                        Начальный
                    </div>
                    <div className={styles.hhDataSalaryCount}>
                        {priceRu(juniorSalary)}
                    </div>
                    <div className={styles.hhDataSalaryRating}>
                        <svg className={styles.hhDataSalaryRatingStar}
